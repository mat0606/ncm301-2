...
7.  Click on **Confirm**.  Click on **Confirm**
...
9.  Fill in the following hardware specification.

    ![](images/Environment-8.png)

10.  Check the **Guest Customization**.  Copy the **cloud-init** contents into the **Guest Customization**
