...
In this exercise you will create a NCM Self Service Blueprint based on a Microsoft Windows 2022 image. The image will be sysprepped with an
...
1.  Click on hamburger menu.  Select **Self Service**
...
2.  Click **+** to add an variable for **DOMAIN_NAME**
...
1. Click on the **+** on the left side of the screen

    ![](images/Add-Join-Domain-Action-1.png)

2.  Fill in the action name on the right side of the screen.  Click on the **+ Task** button.

    ![](images/Add-Join-Domain-Action-2.png)

3.  Fill in the following fields on the **Configuration Panel** on the right:
...
4.  Copy and Paste it in the script section.
...
5.  Fill in the following fields on the **Configuration Panel** on the right:

    -  **Name Task** - Delay for 2 min
    -  **Type** - Delay
    -  **Sleep Interval** - 120

    ![](images/Add-Join-Domain-Action-4.png)

6.  Fill in the following fields on the **Configuration Panel** on the right:
 ...
 7.  Copy and paste the following script into the **Script** field:
...
# Join Action to Package Install
...
5.  Click on **+ Add Task**.  Fill in the following:

    - **Task Name:** Delay for 2 minutes
    - **Type:** Delay
    - **Sleep Interval:** 120

    ![](images/Add-UnJoin-Domain-Action-8.png)  

# Join action to Package Uninstall
