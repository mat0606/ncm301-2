...
1.  On the left side of the screen, click on **+** to add Application Profile

    ![](images/add_application_profile_1.png)  

2.  On the right side of the screen, change the name to **Medium**
