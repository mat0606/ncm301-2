...
4.  Verify the VM sizing.  Click on **Deploy**
...
2.  Click on **Windows - Package Install**.

3.  Click on **Windows - JoinDomain**. Verify the powershell script was executed successfully

4.  Click on the **Services** tab, then select the **WindowsAD** service. Note down the IP address.

5.  Open a Remote Desktop to connect to the provisioned VM.
...
3.  You will be taken directly to the **Applications** page to monitor the provisioning of your Blueprint.
...
4.  Select the **Control Panel**. Select **System and Security**. Select
    **System**
