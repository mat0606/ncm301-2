...
**The trainer will nominate a trainee to work on this section**
...
1.  Logout of Calm VM.  Login as tenent**XYZ**developer@ntnxlab.local user.  Replace XYZ with your assigned no.
